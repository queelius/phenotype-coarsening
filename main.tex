...
\noindent\textbf{Discussion:} The framework names the failing
assumption (C2) and quantifies the bias, unifying Hui-Walter latent
class models, Rogan-Gladen correction, and verification-bias
correction in one vocabulary.
